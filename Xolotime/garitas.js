...
{	
    ...
    //color cuarta caja
    // if (varotay3<60&&varotay3>30) {
    //   $( "#square_peatonal1" ).addClass( "orange" );
    // };
    // if (varotay3<=30) {
    //   $( "#square_peatonal1" ).addClass( "blue" );
    // };
    // if (varotay3>=120) {
    //   $( "#square_peatonal1" ).addClass( "red" );
    // };
    //TECATE
    // Otay
